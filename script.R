# Ввод параметров
L1 <- 11600 # Длина плазмиды pAAV-Helper (Сириус)
L2 <- 7300  # Длина плазмиды capsid AAV (Сириус)
L3 <- 7000  # Длина плазмиды AAV pITR (Сириус)
...
cat("Объем capsid AAV: ", round(Volume2, 2), "мкл\n")
cat("Объем AAV pITR: ", round(Volume3, 2), "мкл\n")
